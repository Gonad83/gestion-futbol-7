...
const PLANS = [
  {
    ...
    limitsLabel: '1 equipo · 7 jugadores + 4 invitados',
    features: [
      'Hasta 7 jugadores en tu squad',
      '4 invitados para completar el partido',
      'Confirmación de asistencia por email con 1 clic',
      'Armado automático de equipos equilibrados por nivel',
      'Control de caja: registra cuotas y gastos del equipo',
      'Vota al MVP al terminar cada partido',
      'Exporta lista y equipos directo a WhatsApp',
    ],
  },
  {
    id: 'pro' as PlanId,
    ...
    features: [
      ...
      'Matchmaking inteligente: equipos por posición y nivel',
      ...
      'Estadísticas de asistencia por jugador (% anual)',
  ...
  },
  {
    ...
    limitsLabel: 'Jugadores ilimitados',
    features: [
      'Todo lo del plan Pro incluido',
      'Jugadores ilimitados en tu squad',
      'Gestiona toda tu liga desde un solo panel',
      'Dashboard con ranking MVP histórico del torneo',
      'Arena: cruza equipos y genera fixtures automáticos',
      'Soporte prioritario (respuesta en menos de 1 hora)',
      'Primero en acceder a cada nueva función',
    ],
  },
];
